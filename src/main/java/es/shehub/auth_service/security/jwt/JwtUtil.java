...
/**
 * Utility class for handling JWT token operations such as creation, parsing,
 * and validation.
 * 
 * Generates access and refresh tokens with embedded user information and
 * expiration settings.
 * Also provides methods to extract information from tokens and check token
 * validity.
 * 
 * The secret key for signing tokens is injected from .env via
 * {@code JWT_SECRET_KEY}.
 * 
...
public class JwtUtil {
     ...
     * @return a signed JWT token valid for 2 hours, containing the user's email and
     *         role
     */
    ...
    /**
     * Generates a short-lived token for password reset purposes.
     *
     * @param email the email of the user requesting the reset
     * @return a signed JWT token valid for 5 minutes
     */
    ...
    /**
     * Validates a token by checking that it matches the expected email and is not
     * expired.
     * 
